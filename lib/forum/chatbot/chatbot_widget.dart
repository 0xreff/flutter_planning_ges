        ...
        body: SafeArea(
          ...
          child: Stack(
            children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                _model.apiResultoku = await ChatbotCall.call(
                                  prompt: _model.promptFieldTextController.text,
                                );

                                if ((_model.apiResultoku?.succeeded ?? true)) {
                                  _model.textreponse = valueOrDefault<String>(
                                    ChatbotCall.apiReponse(
                                      (_model.apiResultoku?.jsonBody ?? ''),
                                    ),
                                    'unset',
                                  );
                                  safeSetState(() {});
              ...
              Align(
                alignment: AlignmentDirectional(-0.67, -0.83),
                child: MarkdownBody(
                  data: _model.textreponse,
                  selectable: true,
