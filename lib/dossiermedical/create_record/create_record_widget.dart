  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> createRecordUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final createRecordUsersRecord = createRecordUsersRecordList.isNotEmpty
            ? createRecordUsersRecordList.first
            : null;
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: 'Please enter the patient reference',
                                            ...
                                            child: Padding(
                                              ...
                                              child: ClipRRect(
                                                borderRadius:
                                                    BorderRadius.circular(50.0),
                                                child: Image.network(
                                                  'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4gpVR6Vqbw9Rqk0hHJvSFKH3i5o7FsL9-Xg&s',
                                                  width: 44.0,
                                                  height: 44.0,
                                                  fit: BoxFit.cover,
                                                ),
                  ...
                  child: Container(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await MedicalRecordsRecord.collection
                            .doc()
                            .set(createMedicalRecordsRecordData(
                              ref: _model.textController.text,
                              createdAt: getCurrentTimestamp,
                              patintid: FFAppState().user,
                            ));
                        ...
                        context.pushNamed(HomeDoctorWidget.routeName);
                      },
                      text: 'Create',
